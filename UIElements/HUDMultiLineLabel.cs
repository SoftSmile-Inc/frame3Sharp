...
namespace f3
{
    ...
    public class HUDMultiLineLabel : HUDStandardItem, IBoxModelElement
    {
        fGameObject entry;
        fGameObject bgMesh;
        fGameObject border;
        ...
        {
            if (Parent == null) {
                DebugUtil.Log(2, "HUDMultiLineLabel.EndCapture: our parent went invalid while we were capturing!");
                return true;
            }
